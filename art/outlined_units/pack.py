...
paths={'clubman':ROOT/'assets/sprites/Units/Clubman','worker':ROOT/'assets/sprites/Units/WorkerOutlined'}
sheets={}
...
icons={'clubman':'clubman_icon.png','worker':'worker_outlined_icon.png'}
...
for unit in data:
    art={'warrior':'clubman','worker':'worker'}.get(unit['name'])
    ...
    if art=='clubman': unit['animations']['guard']=unit['animations']['idle']
...
print('Validated and packed 448 Blender frames: 3 clubman and 4 worker actions, each in 8 directions.')
